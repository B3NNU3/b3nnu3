{strip}
    ...
    {block name=metaData}
        ...
        <meta itemprop="author" content="b3nnu3@gmail.com"/>
    {/block}
    {block name=metaIndex}
    ...
    {/block}
    {block name=linkHref}
        <link rel="author" href="https://google.com/+BennueSchnoor_b3nnu3">
